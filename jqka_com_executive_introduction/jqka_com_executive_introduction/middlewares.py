...
class JqkaComExecutiveIntroductionSpiderMiddleware(object):
...
class JqkaComExecutiveIntroductionDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
...
class SeleniumSpiderMiddleware(object):
    ...
    def process_request(self, request, spider):
        ...
        if spider.name == 'jqka_com_detail_Spider':
            url = request.url
